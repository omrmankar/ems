  ...
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      ...
      <div class="social-icons">
       <ul>
        <li><a href="<?php print $front_page; ?>/rss.xml"><i class="fa fa-rss" aria-hidden="true"></i></a></li>
        <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'business_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
        <li><a href="http://newtechfusion.com/<?php echo theme_get_setting('twitter_username', 'business_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-globe" aria-hidden="true"></i></a></li>
       </ul>
      </div>
    <?php endif; ?>
      <?php if ($logo): ?><div id="logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><img src="<?php print $logo; ?>"/></a>
        ...
        <div class="menu-navigation-container">
          ...
          <div class="user-menu">
            <?php  $main_menu_tree1 = menu_tree(variable_get('menu_main_links_source', 'user-menu')); 
                  ...
                  /* $block = module_invoke('my_custom_block', 'block_view', 'my_custom_block');
